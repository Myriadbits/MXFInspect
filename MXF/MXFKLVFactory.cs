...
namespace Myriadbits.MXF
{
   ...
   //         m_allKeys.Add(new MXFKey(typeof(MXFPartition),								0x06, 0x0e, 0x2b, 0x34, 0x02, 0x05, 0x01, 0x01, 0x0d, 0x01, 0x02, 0x01, 0x01, 0x02));				// Header partition
			...
			// EncryptedTriplet urn: smpte: ul: 060e2b34.027f0101.0d010301.027e0100 ??? 060e2b34				.027f0101			??  .0d010301					.027e0100
			...
			//MXFGCFrameWrappedEncryptedData http://www.smpte-ra.org/reg/400/2012/13/1/aaf 	urn:smpte:ul:060e2b34.04010107.0d010301.020b0100
			...
			m_allKeys.Add(new MXFKey(typeof(MXFSourceReference),						0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x01, 0x01, 0x01, 0x01, 0x10, 0x00)); // Source clip (picture, sound, data)
			...
			m_allKeys.Add(new MXFKey(typeof(MXFLocator),								0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x01, 0x01, 0x01, 0x01, 0x31, 0x00)); // Locator
			...
			dict.Add(new MXFKey(0x06, 0x0e, 0x2b, 0x34, 0x02, 0x53, 0x01, 0x01, 0x0d, 0x01, 0x01, 0x01, 0x01, 0x01, 0x30, 0x00),	typeof(MXFIdentification));		  // Identification
		}
        ...
        public class KeyPartialMatchComparer : IEqualityComparer<MXFKey>
        {
            ...
            {
				// basically force the equality check
                return 0;
            }
        }
