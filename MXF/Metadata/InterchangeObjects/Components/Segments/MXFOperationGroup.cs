    ...
    public class MXFOperationGroup : MXFSegment
    {
        ...
        protected override bool ParseLocalTag(MXFReader reader, MXFLocalTag localTag)
        {
            switch (localTag.Tag)
            {
                ...
                // TODO replace generic MXFObject with class Parameter once implemented
                case 0x0B03: this.ReadReferenceSet<MXFObject>(reader, "Parameters", "Parameter"); return true;
            }
