...
namespace Myriadbits.MXF
{
    ...
    {
        public readonly UL pictureFormatObject_Key = new UL(0x06,0x0e,0x2,0xb,0x34,0x01,0x01,0x01,0x05,0x06,0x01,0x01,0x04,0x02,0x40,0x1d,0x00);
        public readonly UL projectObject_Key = new UL(0x06,0x0e,0x2,0xb,0x34,0x01,0x01,0x01,0x05,0x06,0x01,0x01,0x04,0x02,0x40,0x21,0x00);
        public readonly UL captionsDescriptionObjects_Key = new UL(0x06,0x0e,0x2,0xb,0x34,0x01,0x01,0x01,0x05,0x06,0x01,0x01,0x04,0x05,0x40,0x0c,0x00);
        public readonly UL contractObjects_Key = new UL(0x06,0x0e,0x2,0xb,0x34,0x01,0x01,0x01,0x05,0x06,0x01,0x01,0x04,0x05,0x40,0x19,0x00);

        public MXFProductionClipFramework(MXFReader reader, MXFPack pack)
            : base(reader, pack)
        {
