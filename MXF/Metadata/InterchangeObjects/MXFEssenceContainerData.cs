...
namespace Myriadbits.MXF
{
    ...
    public class MXFEssenceContainerData : MXFInterchangeObject
    {
        ...
        private readonly UL precedingIndexTable_Key = new UL(0x06, 0x0E, 0x2B, 0x34, 0x01, 0x01, 0x01, 0x09, 0x06, 0x01, 0x01, 0x04, 0x06, 0x10, 0x00, 0x00);
        private readonly UL followingIndexTable_Key = new UL(0x06, 0x0E, 0x2B, 0x34, 0x01, 0x01, 0x01, 0x09, 0x06, 0x01, 0x01, 0x04, 0x06, 0x10, 0x00, 0x00);
        private readonly UL isSparse_Key = new UL(0x06, 0x0E, 0x2B, 0x34, 0x01, 0x01, 0x01, 0x09, 0x06, 0x01, 0x01, 0x04, 0x06, 0x10, 0x00, 0x00);
        private readonly UL singularPartitionUsage_Key = new UL(0x06, 0x0E, 0x2B, 0x34, 0x01, 0x01, 0x01, 0x09, 0x06, 0x01, 0x01, 0x04, 0x06, 0x10, 0x00, 0x00);

        [Category(CATEGORYNAME)]
        [ULElement("urn:smpte:ul:060e2b34.01010102.06010106.01000000")]
        public UMID LinkedPackageID { get; set; }
