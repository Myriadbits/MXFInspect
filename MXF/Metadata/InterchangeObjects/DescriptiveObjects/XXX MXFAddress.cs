		...
		protected override bool ParseLocalTag(MXFReader reader, MXFLocalTag localTag)
		{
			if (localTag.Key != null)
			{
				switch (localTag.Key)
				{
					...
					case var a when localTag.Key == postalTown_Key: this.PostalTown = reader.ReadUTF16String(localTag.Size); return true;
					case var a when localTag.Key == city_Key: this.City = reader.ReadUTF16String(localTag.Size); return true;
					case var a when localTag.Key == stateProvinceCountry_Key: this.StateProvinceCounty = reader.ReadUTF16String(localTag.Size); return true;
					case var a when localTag.Key == postalCode_Key: this.PostalCode = reader.ReadUTF16String(localTag.Size); return true;
					case var a when localTag.Key == country_Key: this.Country = reader.ReadUTF16String(localTag.Size); return true;
					case var a when localTag.Key == roomSuiteName_Key: this.RoomSuiteName = reader.ReadUTF16String(localTag.Size); return true;
					case var a when localTag.Key == buildingName_Key: this.BuildingName = reader.ReadUTF16String(localTag.Size); return true;
					case var a when localTag.Key == placeName_Key: this.PlaceName = reader.ReadUTF16String(localTag.Size); return true;
					case var a when localTag.Key == geoCoordinates_Key: this.GeographicalCoordinates = reader.ReadArray(reader.ReadByte, 12); return true;
					case var a when localTag.Key == astroBodyName_Key: this.AstronomicalBodyName = reader.ReadUTF16String(localTag.Size); return true;
				}
			}
