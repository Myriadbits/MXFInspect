...
namespace Myriadbits.MXF
{
    ...
    public class MXFTypeDefinitionEnumeration : MXFTypeDefinition
    {
        ...
        public MXFTypeDefinitionEnumeration(MXFPack pack)
            : base(pack)
        {
        ...
        protected override bool ParseLocalTag(IKLVStreamReader reader, MXFLocalTag localTag)
        {
            switch (localTag.TagValue)
            {
                ...
                case 0x0014: this.AddChild(reader.ReadReference<MXFTypeDefinition>("ElementType", localTag.Offset)); return true;
            }
