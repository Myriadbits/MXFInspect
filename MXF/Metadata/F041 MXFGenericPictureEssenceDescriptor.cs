...
namespace Myriadbits.MXF
{
    public class MXFGenericPictureEssenceDescriptor : MXFFileDescriptor
    {
        ...
        protected override bool ParseLocalTag(MXFReader reader, MXFLocalTag localTag)
        {
            switch (localTag.Tag)
            {
                case 0x3215: this.SignalStandard = (MXFSignalStandard)reader.ReadB(); return true;
                case 0x320C: this.FrameLayout = (MXFFrameLayout)reader.ReadB(); return true;
                ...
                case 0x3212: this.FieldDominance = (MXFFieldNumber)reader.ReadB(); return true;
