    ...
    public class MXFMPEGPictureEssenceDescriptor : MXFCDCIPictureEssenceDescriptor
    {
        ...
        protected override bool ParseLocalTag(MXFReader reader, MXFLocalTag localTag)
        {
            if (localTag.Key != null)
            {
                switch (localTag.Key)
                {
                    case var a when localTag.Key == bitRate_Key: this.BitRate = reader.ReadD(); return true;
                    case var a when localTag.Key == identicalGOPIndicator_Key: this.IdenticalGOPIndicator = reader.ReadBool(); return true;
                    case var a when localTag.Key == maxGOPSize_Key: this.MaximumGOPSize = reader.ReadW(); return true;
                    case var a when localTag.Key == maxBPictureCount_Key: this.MaximumBPictureCount = reader.ReadW(); return true;
                    case var a when localTag.Key == constantBPictureFlag_Key: this.ConstantBPictureFlag = reader.ReadBool(); return true;
                    case var a when localTag.Key == codedContentScanningKind_Key: this.CodedContentScanningKind = (MXFCodedContentScanning)reader.ReadB(); return true;
                    case var a when localTag.Key == profileAndLevel_Key: this.ProfileAndLevel = reader.ReadB(); return true;
